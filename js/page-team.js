  ...
  var TEAM = [
    {
      ...
      members: [
        ...
        { name: 'Sileranda Paul', role: 'Programme Manager', location: 'Maiduguri, Borno', tenure: 'Since 2025', photo: 'assets/Team/pm.jpeg', bio: 'Oversees programme planning, quality and cross-sector coordination.', bioFull: 'Sileranda oversees programme planning, quality assurance and cross-sector coordination, working closely with thematic leads to keep delivery on track across all seven states of operation.', tags: ['Programme Planning', 'Quality Assurance', 'Coordination'],
    ...
    },
    {
      ...
      members: [
        ...
        { name: 'Japari Hyelafiya', role: 'WASH & Food Security and Livelihoods Coordinator', location: 'Yola, Adamawa', tenure: 'Since 2025', photo: 'assets/Team/ef.jpeg', bio: 'Leads clean water, sanitation, food distribution and livelihoods support.', bioFull: 'Japari coordinates water point construction, sanitation and hygiene promotion alongside food distributions, savings groups and vocational training — helping households recover both health and income.', tags: ['Water & Sanitation', 'Food Distribution', 'Livelihoods'],
        ...
        { name: 'Ndihyelia Sani', role: 'Education Officer', location: 'Maiduguri, Borno', tenure: 'Since 2025', photo: 'assets/Team/fsl.jpeg', bio: 'Runs scholarships, learning materials and girls’ retention programmes.', bioFull: 'Ndihyelia runs HHI’s scholarship scheme, learning-materials distribution and girls’ retention initiatives, working with schools to keep conflict-affected children in class.', tags: ['Girls’ Education', 'Scholarships', 'Learning Materials'],
        ...
        { name: 'Janada John', role: 'Protection Coordinator', location: 'Jere, Borno', tenure: 'Since 2025', photo: 'assets/Team/pc.jpeg', bio: 'Directs case management, psychosocial support and safe spaces.', bioFull: 'Janada directs case management, psychosocial support and safe-space programming for survivors of violence and vulnerable children across HHI’s protection sites.', tags: ['Case Management', 'GBV Response', 'Psychosocial Support'],
